...
(()=>{
    const e = new Error("Cannot find module '@/lib/samsungHealth'");
...
function SamsungHealthConnect({ userId, onSync }) {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "SamsungHealthConnect.useEffect": ()=>{
            ...
            const token = getSamsungHealthToken(userId);
    ...
    const handleConnect = async ()=>{
        ...
        if (confirmed) {
            ...
            storeSamsungHealthToken(userId, mockToken);
            setIsConnected(true);
    ...
    const handleDisconnect = ()=>{
        if (confirm('Disconnect Samsung Health? Your health data will no longer sync.')) {
            removeSamsungHealthToken(userId);
    ...
    const handleSync = async ()=>{
        ...
        try {
            ...
            const service = new SamsungHealthService(token);
            ...
            // Convert to sessions
            const healthSessions = SamsungHealthService.convertToSessions(sleepData, workoutData);
...
//# sourceMappingURL=src_2e20062a._.js.map