...
function SessionCard({ session, onUpdate, onDelete, isActive = false }) {
    ...
    const [editStartTime, setEditStartTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(dateToTimeString(session.startTime));
    const [editEndTime, setEditEndTime] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f2e$pnpm$2f$next$40$16$2e$0$2e$8_$40$babel$2b$core$40$7$2e$28$2e$5_react$2d$dom$40$19$2e$2$2e$1_react$40$19$2e$2$2e$1_$5f$react$40$19$2e$2$2e$1$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useState"])(session.endTime ? dateToTimeString(session.endTime) : '');
...
_s(SessionCard, "5NARj3OEGA1X5DMPrXxqb3LsOXY=");
_c = SessionCard;
var _c;
...
class GoogleFitService {
   ...
   */ async getSleepData(startDate, endDate) {
        ...
        try {
            ...
            console.log('🔍 Fetching sleep from Google Fit:', {
                url,
            ...
            const sleepSessions = (data.session || []).filter((session)=>session.activityType === 72) // Sleep activity
            .map((session)=>{
   ...
   */ async getWorkoutData(startDate, endDate) {
        ...
        try {
            ...
            console.log('🔍 Fetching workouts from Google Fit:', {
                url,
                startDate: startDate.toISOString(),
                endDate: endDate.toISOString()
            });
            ...
            console.log('📦 Raw Google Fit workout response:', {
                totalSessions: data.session?.length || 0,
                hasSession: !!data.session,
                activityTypes: data.session?.map((s)=>s.activityType).join(', ') || 'none',
                firstSession: data.session?.[0]
            });
   ...
   */ static convertToSessions(sleepData, workoutData) {
        console.log('🔄 Converting to sessions:', {
...
//# sourceMappingURL=src_f092cf12._.js.map