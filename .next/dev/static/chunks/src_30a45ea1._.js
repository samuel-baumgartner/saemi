...
class GoogleFitService {
   ...
   */ async getSleepData(startDate, endDate) {
        ...
        try {
            ...
            console.log('  Raw sessions found:', data.session?.length || 0);
            ...
            console.log('  After filtering (activity type 72):', sleepSessions.length);
...
//# sourceMappingURL=src_30a45ea1._.js.map